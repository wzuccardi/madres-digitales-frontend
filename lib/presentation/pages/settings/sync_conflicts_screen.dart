    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Opciones de resolución (migrado a SegmentedButton)
          SegmentedButton<String>(
            segments: const <ButtonSegment<String>>[
              ButtonSegment<String>(
                value: 'local_wins',
                label: Text('Mantener cambios locales'),
                icon: Icon(Icons.smartphone),
              ),
              ButtonSegment<String>(
                value: 'server_wins',
                label: Text('Usar cambios del servidor'),
                icon: Icon(Icons.cloud_sync),
              ),
            ],
            selected: <String>{_selectedResolution},
