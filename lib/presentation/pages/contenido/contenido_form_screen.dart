...
import 'package:madres_digitales_flutter_new/presentation/widgets/common/custom_button.dart';
  ...
  Future<void> _guardarConArchivo(ContenidoUnificado contenido, dynamic contenidoService) async {
    try {
      ...
      if (response.statusCode != 201) {
        ...
        final msg = (body?['message'] as String?) ?? 'Error guardando contenido con archivo';
        throw Exception(msg);
      }
              ...
              DropdownButtonFormField<String>(
                ...
                items: _tipos.map((tipo) {
                  return DropdownMenuItem(
                    value: tipo,
                    child: Text(TipoContenido.fromString(tipo.toLowerCase()).nombre),
                  );
                }).toList(),
                onChanged: (value) {
                  if (value != null) {
