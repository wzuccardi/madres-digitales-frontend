...
class SimpleDataService {
  ...
  SimpleDataService(this._apiService);
    ...
    switch (estado) {
      case 'vencidos':
        return controles.where((control) {
          ...
          return ahora.difference(control.fechaControl).inDays > 30;
        }).toList();
      
      case 'pendientes':
        return controles.where((control) {
          // Considerar pendientes los controles recientes (Ãºltimos 7 dÃ­as)
          return ahora.difference(control.fechaControl).inDays <= 7;
        }).toList();
          ...
          try {
            ...
            try {
              ...
              final gestantesMadrina = todasGestantes
                  .where((g) => g.madrinaTieneAcceso(madrinaId))
                  .toList();
        ...
        Future<bool> asignarGestanteAMadrina({
          ...
          try {
            ...
            if (data is Map<String, dynamic>) {
              ...
              final successFlag = successVal == true || successVal?.toString() == 'true';
              if (successFlag) {
                return true;
              }
            }
