...
class SOSAlarmService {
  ...
  void _reproducirBeepsWeb() {
    ...
    _soundTimer = Timer.periodic(const Duration(milliseconds: 500), (timer) {
      ...
      try {
        ...
        // Error al reproducir sonido de alarma, se continúa con el siguiente
        AppLogger.error('Error reproduciendo sonido de alarma: $e');
      }
  ...
  Future<void> _activarVibracionIntensa() async {
    ...
    try {
      ...
      // Error al activar vibración, se continúa sin ella
      AppLogger.error('Error activando vibración: $e');
    }
  }
  ...
  Future<void> detenerAlarma() async {
    ...
    try {
      ...
      // Error al detener el audio, se continúa con la limpieza
