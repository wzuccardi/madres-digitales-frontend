...
import 'package:madres_digitales_flutter_new/features/gestante/presentation/widgets/assignment_confirmation_dialog.dart';
...
class _AssignGestantePageState extends ConsumerState<AssignGestantePage> {
  ...
  Future<void> _submitAssignment() async {
    ...
    if (!(await authService.isLoggedIn) || authService.userId == null) {
      setState(() {
