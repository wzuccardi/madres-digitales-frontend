...
import 'package:madres_digitales_flutter_new/application/providers/contenido_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Builder(
          builder: (context) {
            if (contenidosState.status == ContenidoSimpleStatus.loading && contenidosState.contenidos.isEmpty) {
