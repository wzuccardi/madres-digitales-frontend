...
class DatabaseHelper {
  ...
  Future<void> _onCreate(Database db, int version) async {
    AppLogger.info('Creando tablas de base de datos...');
    ...
    AppLogger.info('Base de datos creada exitosamente');
  }

  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    AppLogger.info('Actualizando base de datos de versión $oldVersion a $newVersion');
