...
class _ContenidoCrudScreenState extends ConsumerState<ContenidoCrudScreen> {
  ...
  Future<void> _duplicarContenido(ContenidoModel contenido) async {
    try {
      final contenidoService = ref.read(contenidoServiceProvider);
  ...
  void _irAFormulario({ContenidoModel? contenido}) {
  ...
  List<ContenidoModel> get _contenidosFiltrados {
  ...
  ContenidoModel _convertToContenidoModel(ContenidoUnificado contenido) {
  ...
  ContenidoUnificado _convertToContenidoUnificado(ContenidoModel contenido) {
