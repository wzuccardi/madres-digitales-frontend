...
import 'package:madres_digitales_flutter_new/core/providers/integrated_admin_provider.dart';
import 'package:madres_digitales_flutter_new/models/integrated_models.dart';
import 'package:madres_digitales_flutter_new/features/municipios/presentation/screens/municipios_admin_screen.dart';
...
class _SuperAdminScreenState extends ConsumerState<SuperAdminScreen> {
          ...
          children: [
            Expanded(
              child: _buildStatCard(
                'Municipios',
                '${_valInt(resumen, ['municipiosActivos','municipios_activos'])}/${_valInt(resumen, ['totalMunicipios','total_municipios'])}',
                Colors.blue,
                Icons.location_city,
              ),
            ),
            ...
            Expanded(
              child: _buildStatCard(
                'IPS',
                '${_valInt(resumen, ['ipsActivas','ips_activas'])}/${_valInt(resumen, ['totalIPS','total_ips'])}',
                Colors.green,
            ...
            Expanded(
              child: _buildStatCard(
                'Médicos',
                '${_valInt(resumen, ['medicosActivos','medicos_activos'])}/${_valInt(resumen, ['totalMedicos','total_medicos'])}',
                Colors.orange,
            ...
            Expanded(
              child: _buildStatCard(
                'Gestantes',
                '${_valInt(resumen, ['gestantesActivas','gestantes_activas'])}',
                Colors.purple,
  ...
  int _valInt(Map<String, dynamic> data, List<String> keys) {
    for (final k in keys) {
      final v = data[k];
