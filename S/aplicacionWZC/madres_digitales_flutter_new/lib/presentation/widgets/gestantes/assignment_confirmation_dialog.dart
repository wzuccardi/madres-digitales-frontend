                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        (() {
                          final fn = gestante.fechaNacimiento;
                          if (fn == null) return '-';
                          var edad = DateTime.now().year - fn.year;
                          final hasHadBirthday = DateTime.now().month > fn.month || (DateTime.now().month == fn.month && DateTime.now().day >= fn.day);
                          if (!hasHadBirthday) edad -= 1;
                          return '$edad años';
                        })(),
                        style: const TextStyle(fontWeight: FontWeight.w500),
                      ),
                      const Spacer(),
                      if (gestante.riesgoAlto)
                        Container(
